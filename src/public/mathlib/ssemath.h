...
// * Switch from int32 to uint32 for many of these, to solve some compiler
//  warnings, with a HACKHACK: coolint32 type that is only signed sometimes :P
...
#ifdef _MSC_VER
// because the SSDK2013 doesn't come with sourcecode for particles.lib
// we can't change the type on Windows.
#define coolint32 int32
#else
// Meanwhile, changing to uint32 on linux doesn't just work
// it solves a warning!
#define coolint32 uint32
#endif

// external aligned integer constants
extern const ALIGN16 coolint32 g_SIMD_clear_signmask[] ALIGN16_POST;			// 0x7fffffff x 4
extern const ALIGN16 coolint32 g_SIMD_signmask[] ALIGN16_POST;				// 0x80000000 x 4
extern const ALIGN16 coolint32 g_SIMD_lsbmask[] ALIGN16_POST;				// 0xfffffffe x 4
extern const ALIGN16 coolint32 g_SIMD_clear_wmask[] ALIGN16_POST;			// -1 -1 -1 0
extern const ALIGN16 coolint32 g_SIMD_ComponentMask[4][4] ALIGN16_POST;		// [0xFFFFFFFF 0 0 0], [0 0xFFFFFFFF 0 0], [0 0 0xFFFFFFFF 0], [0 0 0 0xFFFFFFFF]
extern const ALIGN16 coolint32 g_SIMD_AllOnesMask[] ALIGN16_POST;			// ~0,~0,~0,~0
extern const ALIGN16 coolint32 g_SIMD_Low16BitsMask[] ALIGN16_POST;			// 0xffff x 4
...
extern const coolint32 ALIGN16 g_SIMD_SkipTailMask[4][4] ALIGN16_POST;
