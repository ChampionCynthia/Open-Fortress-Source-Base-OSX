...
// these were found by just converting the hex values to decimals - cherry
...
acttable_t COFWeaponBase::m_acttablePrimary[] =
{
	...
	// THIS IS WRONG! find out what it actually is
	{ ACT_MP_GESTURE_VC_FISTPUMP_BUILDING, ACT_MP_GESTURE_VC_THUMBSUP_BUILDING, false },
	...
	// THESE ARE WRONG! gotta figure them out
	{ ACT_MP_SWIM_BUILDING, ACT_MP_ATTACK_CROUCH_GRENADE_BUILDING, false },
	{ ACT_MP_ATTACK_STAND_BUILDING, ACT_MP_ATTACK_SWIM_GRENADE_BUILDING, false },
	{ ACT_MP_ATTACK_CROUCH_BUILDING, ACT_MP_ATTACK_AIRWALK_GRENADE_BUILDING, false },
	{ ACT_MP_ATTACK_SWIM_BUILDING, ACT_MP_STAND_BUILDING_DEPLOYED, false },
	{ ACT_MP_ATTACK_AIRWALK_BUILDING, ACT_MP_CROUCH_BUILDING_DEPLOYED, false },
	{ ACT_MP_ATTACK_STAND_GRENADE_BUILDING, ACT_MP_RUN_BUILDING_DEPLOYED, false },
	...
	// THESE ARE WRONG! gotta figure them out
	{ ACT_MP_GESTURE_VC_NODYES_PDA, ACT_MP_PASSTIME_THROW_MIDDLE, false },
	{ ACT_MP_GESTURE_VC_NODNO_PDA, ACT_MP_PASSTIME_THROW_END, false },
	{ ACT_MP_STUN_BEGIN, ACT_MP_PASSTIME_THROW_CANCEL, false },
	{ ACT_MP_STUN_MIDDLE, ACT_VM_UNUSABLE, false },
	{ ACT_MP_STUN_END, ACT_VM_UNUSABLE_TO_USABLE, false },
	{ ACT_MP_PASSTIME_THROW_BEGIN, ACT_VM_USABLE_TO_UNUSABLE, false },

	// this doesnt exist? probably can be removed
	{ 1897, 1898, false }
};
